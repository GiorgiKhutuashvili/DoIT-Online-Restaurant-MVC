        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoodBasketId = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodBasketItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FoodBasketItems_Dishes_DishId",
                        column: x => x.DishId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodBasketItems_DishId",
                table: "FoodBasketItems",
                column: "DishId");
